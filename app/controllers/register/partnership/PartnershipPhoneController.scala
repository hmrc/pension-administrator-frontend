...
import identifiers.register.partnership.{PartnershipDetailsId, PartnershipPhoneId}
...
class PartnershipPhoneController @Inject()(@Partnership val navigator: Navigator,
  ...
  private def entityName(implicit request: DataRequest[AnyContent]): String =
    request.userAnswers.get(PartnershipDetailsId).fold(Message("thePartnership").resolve)(_.companyName)
