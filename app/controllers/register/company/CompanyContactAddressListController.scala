...
class CompanyContactAddressListController @Inject()(
    ...
    (BusinessNameId and CompanyContactAddressPostCodeLookupId).retrieve.map {
      case name ~ addresses =>
        AddressListViewModel(
          ...
          addresses = addresses,
          Message("companyPartnership.select.contact.address.heading", Message("theCompany")),
          Message("companyPartnership.select.contact.address.heading", name),
