...
import controllers.register.company.routes.NonUkCompanySameContactAddressController
...
@Singleton()
class NonUkCompanySameContactAddressController @Inject()(
  ...
  private[controllers] val postCall = NonUkCompanySameContactAddressController.onSubmit _
