...
class DirectorAddressViewSpec extends QuestionViewBehaviours[Address] {
  ...
  def createView = () => directorAddress(frontendAppConfig, form, NormalMode, firstIndex)(fakeRequest, messages)

  def createViewUsingForm = (form: Form[_]) => directorAddress(frontendAppConfig, form, NormalMode, firstIndex)(fakeRequest, messages)
