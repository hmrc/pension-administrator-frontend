...
class HasPartnershipVATControllerSpec extends ControllerSpecBase {
  ...
  private val form = formProvider("hasVAT.error.required", partnershipName)

  private def viewModel =
    CommonFormWithHintViewModel(
      postCall = controllers.register.partnership.routes.HasPartnershipVATController.onSubmit(NormalMode),
