...
class DirectorAddressControllerSpec extends ControllerSpecBase {
  ...
  def viewAsString(form: Form[_] = form) = directorAddress(frontendAppConfig, form, NormalMode, firstIndex)(fakeRequest, messages).toString
  ...
  "directorAddress Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      val validData = Json.obj(directorAddressId.toString -> Address("value 1", "value 2", None, None, None, "GB"))
