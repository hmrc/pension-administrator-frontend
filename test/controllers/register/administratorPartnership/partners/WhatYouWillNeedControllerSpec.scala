...
import views.html.register.administratorPartnership.partners.whatYouWillNeed
...
class WhatYouWillNeedControllerSpec extends ControllerSpecBase {
  ...
  private def viewAsString(): String =
    view(routes.PartnerNameController.onPageLoad(NormalMode, index = 0),"Test Partnership Name")(fakeRequest, messages).toString
